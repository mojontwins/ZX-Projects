...
Sub usage
	...
	Print "8bit_coords    Use byte coordinates instead of int coordinates for enems"
	Print "in_pixels      Store x1, y1, x2, y2 boundaries in pixels"
	Print ""
End Sub
...
Dim As Integer byteCoordinates, inPixels
...
byteCoordinates = (sclpGetValue ("8bit_coords") <> "")
inPixels = (sclpGetValue ("in_pixels") <> "")
