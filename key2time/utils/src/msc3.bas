...
Function procesaClausulas (f As integer) As String
	...
	If doIncludeDecos Then
		...
		Open decoInclude For Input as #dF
			' Buscamos la pantalla en cuesti󮍊
...
if command (1) = "" or  maxidx = 0 then
	print "MojonTwins Scripts Compiler 3.95"
	print "MT Engine MK2 v0.90+"
	Print
	print "uso: msc3 input n_pants [rampage]"
	print ""
	print "input   - archivo de script"
	print "n_pants - num. de pantallas"
	print "rampage - incluye 'rampage' si los scripts irᮠen otra pagina de RAM"
	print
	system
end if
...
Print #f3, "// Generado por Mojon Script Compiler 3 de la MT Engine MK2"
...
Print #f3, "        BINARY ""../bin/scripts.bin"""
Print #f3, "#endasm"
Print #f3, "#endif"
...
Print #f3, "    debug_print_16bits (0, 0, asm_int [0]);"
Print #f3, "#endif"
Print #f3, ""
Print #f3, "#ifdef MODE_128K"
Print #f3, "    #asm"
...
Print #f3, "#ifdef DEBUG"
Print #f3, "    debug_print_16bits (5, 0, script);"
Print #f3, "#endif"
print #f3, ""
If maxItem > 0 then
...
if clausulasUsed (&H20) Then
	...
	print #f3, "                    //sc_terminado = (0 == (prx + 8 >= sc_x && prx + 8 <= sc_x + 15 && pry + 14 >= sc_y - 15 && pry + 14 <= sc_y + 15));"
	print #f3, "                    sc_terminado = (0 == (prx + 8 >= sc_x && prx <= sc_x + 7 && pry + 29 >= sc_y && pry <= sc_y + 1));"
	print #f3, "#else"
	print #f3, "                    sc_terminado = (!(prx + 15 >= sc_x && prx <= sc_x + 15 && pry + 15 >= sc_y && pry <= sc_y + 15));"
	print #f3, "#endif"
	print #f3, "                    break;"
end if
...
If actionsUsed (&H6E) Then
	...
	print #f3, "                        for (sc_c = 0; sc_c < 160; sc_c ++) {"
	print #f3, "                            _x = sc_x; _y = sc_y; _n = map_attr [sc_c]; _t = map_buff [sc_c]; update_tile ();"
	print #f3, "                            sc_x ++; if (sc_x == 15) { sc_x = 0; sc_y ++; sc_c ++; }"
	print #f3, "						}"
	print #f3, "#ifdef ENABLE_FLOATING_OBJECTS"
	print #f3, "                        FO_paint_all ();"
	print #f3, "#endif"
