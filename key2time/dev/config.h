...
#define PLAYER_LIFE 			99	//5	// Max and starting life gauge.
...
#define ENABLE_SIMPLE_PURSUERS			// Simpler type 7s.
...
/*
#define PLAYER_FALL_VY_MAX		192 	// Max falling speed (512/64 = 8 pixels/frame)
#define PLAYER_G				64		// Gravity acceleration (32/64 = 0.5 pixels/frame^2)

#define PLAYER_JMP_VY_INITIAL	96		// Initial junp velocity (64/64 = 1 pixel/frame)
#define PLAYER_JMP_VY_MAX		192 	// Max jump velocity (320/64 = 5 pixels/frame)
...
#define PLAYER_FALL_VY_MAX		48	 	// Max falling speed (512/64 = 8 pixels/frame)
#define PLAYER_G				16		// Gravity acceleration (32/64 = 0.5 pixels/frame^2)

#define PLAYER_JMP_VY_INITIAL	24		// Initial junp velocity (64/64 = 1 pixel/frame)
#define PLAYER_JMP_VY_MAX		48	 	// Max jump velocity (320/64 = 5 pixels/frame)
#define PLAYER_JMP_VY_INCR		24		// acceleration while JUMP is pressed (48/64 = 0.75 pixels/frame^2)

#define PLAYER_JETPAC_VY_INCR	half_life		// Vertical jetpac gauge
...
#define PLAYER_RX				12		// Friction (32/64 = 0,5 pixels/frame^2)

#define PLAYER_AX_ALT			half_life 		// Acceleration (alternate) when stepping on tile w/beh. 64
#define PLAYER_RX_ALT			half_life 		// Friction (alternate) when stepping on tile w/beh. 64
...
unsigned char behs [] = {
	3, 0,64, 8, 8, 8, 8, 8, 8,38,36,32,34, 8, 8, 0,
	8, 8, 0, 1, 3, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8,
